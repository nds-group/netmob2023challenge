...
The list of communnes that compose these metropoles/cities are given in the [`cities_communes.txt`](data/cities_communes.txt) dictionary, and the GeoJson files are in the [`metropoles_communes`](data/metropoles_communes) folder.
